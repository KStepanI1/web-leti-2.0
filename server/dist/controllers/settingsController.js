...
var SettingsController = /** @class */ (function () {
    ...
    SettingsController.prototype.put = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var week, settings, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (settings === null || settings === void 0 ? void 0 : settings.update({ week: week }))];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, res.status(201).json(settings)];
                    case 3:
                        err_2 = _a.sent();
